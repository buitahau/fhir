...
import owt.training.fhir.auth.dto.FhirAuthorizationInterceptorDto;
...
public class FhirAuthorizationInterceptor extends AuthorizationInterceptor {
    ...
    private static final Logger log = LoggerFactory.getLogger(owt.training.fhir.auth.interceptor.FhirAuthorizationInterceptor.class);
    ...
    public Verdict applyRulesAndReturnDecision(RestOperationTypeEnum theOperation, RequestDetails theRequestDetails,
        ...
        FhirAuthorizationInterceptorDto authorizationInterceptorDto =
                new FhirAuthorizationInterceptorDto(theRequestDetails);

        return evaluate(authorizationInterceptorDto);
    }

    private Verdict evaluate(FhirAuthorizationInterceptorDto authorizationInterceptorDto) {
    ...
    private Verdict evaluateHttpMapping(FhirAuthorizationInterceptorDto authorizationInterceptorDto,
        ...
        return new VerdictWrapper(PolicyEnum.DENY).buildVerdict();
    }
